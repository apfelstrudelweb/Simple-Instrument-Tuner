...
extension DropDown: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let upperText = dataArray[indexPath.row].components(separatedBy: "---").first
        var lowerText = dataArray[indexPath.row].components(separatedBy: "---").last
        
        if lowerText == upperText { lowerText = "" }
        ...
        cell?.detailTextLabel?.text = lowerText
...
extension DropDown: UITableViewDelegate {
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        UIView.animate(withDuration: 0.5,
                       ...
                       completion: { (didFinish) -> Void in
                        let upperText = selectedText.components(separatedBy: "---").first
                        self.text = upperText
